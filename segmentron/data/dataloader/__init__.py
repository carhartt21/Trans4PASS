...
from .skycloud import SkyCloudSegmentation
from .skycloud360 import SkyCloud360Segmentation
...
datasets = {
    ...
    'skycloud': SkyCloudSegmentation,
    'skycloud360': SkyCloud360Segmentation,
}
